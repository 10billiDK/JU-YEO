...
fonts = [
    {
        "name": "Roboto",
        "fn_regular": fonts_path + "NotoSansKR-Regular.otf",
        "fn_bold": fonts_path + "NotoSansKR-Bold.otf",
        "fn_italic": fonts_path + "Roboto-Italic.ttf",
        "fn_bolditalic": fonts_path + "Roboto-BoldItalic.ttf",
    },
    {
        "name": "RobotoThin",
        "fn_regular": fonts_path + "NotoSansKR-Thin.otf",
        "fn_italic": fonts_path + "Roboto-ThinItalic.ttf",
    },
    {
        "name": "RobotoLight",
        "fn_regular": fonts_path + "NotoSansKR-Light.otf",
        "fn_italic": fonts_path + "Roboto-LightItalic.ttf",
    },
    {
        "name": "RobotoMedium",
        "fn_regular": fonts_path + "NotoSansKR-Medium.otf",
        "fn_italic": fonts_path + "Roboto-MediumItalic.ttf",
    },
    {
        "name": "RobotoBlack",
        "fn_regular": fonts_path + "NotoSansKR-Black.otf",
    ...
    {
        "name": "Gugi",
        "fn_regular": fonts_path + "Gugi-Regular.ttf",
    },
]
